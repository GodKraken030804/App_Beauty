...
import './ingresos_view.dart'; // Vista por curso
import 'package:app_beauty/src/views/mi_perfil_view.dart'; // Navegación perfil

class IngresosCursosView extends StatefulWidget {
  const IngresosCursosView({super.key});

  @override
  State<IngresosCursosView> createState() => _IngresosCursosViewState();
}

class _IngresosCursosViewState extends State<IngresosCursosView>
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => IngresosView(curso: curso),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
